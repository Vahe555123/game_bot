...
export function LocalizationBadge({ localizationName, className }: LocalizationBadgeProps) {
  ...
  return (
    <span
      ...
      className={clsx(
        'pill',
        localization.status === 'full' && 'border-emerald-400/20 bg-emerald-500/20 text-emerald-50',
        localization.status === 'partial' && 'border-sky-400/20 bg-sky-500/20 text-sky-50',
